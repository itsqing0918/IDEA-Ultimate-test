package com.zhaoq.demo08at1227;
...
public class SougouImgProcessor {
    ...
    public void process(int idx, int size) {
        String res = com.zhaoq.demo08at1227.HttpClientUtils.get(String.format(this.url, idx, size, this.word));
//                HttpClientUtils.get(String.format(this.url, idx, size, this.word));
    ...
    public static void main(String[] args) {
        ...
        SougouImgProcessor processor = new SougouImgProcessor(url,"车模");
